...
if (lineOne < (lineTwo + lineThree)) and (lineTwo < (lineOne + lineThree)) and (lineThree < (lineOne + lineTwo)):
    print(f'As retas com comprimento {lineOne:.2f}, {lineTwo:.2f} e {lineThree:.2f} \033[32mPODEM FORMAR\033[m um triângulo')
else:
    print(f'As retas com comprimento {lineOne:.2f}, {lineTwo:.2f} e {lineThree:.2f} \033[31mNÃO PODEM FORMAR\033[m um triângulo')
